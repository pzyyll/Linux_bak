            ...
            <ul id="menu" class="collapse">
				...
				<li class="panel active">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#blank-nav">
                        <i class="icon-check-empty"></i> 视频管理
                    ...
                    <ul class="in" id="blank-nav">
                        ...
                        <li><a href="video_list_bts.php"><i class="icon-angle-right"></i> 视频列表  </a></li>
                        <li><a href="video_add.php"><i class="icon-angle-right"></i> 添加视频  </a></li>
                    </ul>
                </li>

			    <li class="panel">
                    <a href="comment_list.php" >
                        <i class="icon-pencil"></i> 评论管理
                    </a>                   
                </li>
                ...
                <li class="panel ">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed" data-target="#form-nav">
                        <i class="icon-pencil"></i> VIDEO_ADMIN
                    ...
                    <ul class="collapse" id="form-nav">
                        ...
                        <li class=""><a href="forms_videoupload.html"><i class="icon-angle-right"></i> VideoUpload </a></li>
